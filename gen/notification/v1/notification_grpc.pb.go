...
const (
	...
	NotificationService_GetHealth_FullMethodName        = "/notification.v1.NotificationService/GetHealth"
)
...
type NotificationServiceClient interface {
	...
	// GetHealth checks the health of the notification service.
...
func (c *notificationServiceClient) GetHealth(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedNotificationServiceServer) GetHealth(context.Context, *HealthRequest) (*HealthResponse, error) {
...
func _NotificationService_GetHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).GetHealth(ctx, req.(*HealthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
